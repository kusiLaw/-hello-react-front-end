...
- [📖 React Rails Hello World   ](#-react-rails-hello-world---)
...
<details>
  ...
  <ul>
    <li><a href="https://nodejs.org/en/docs/guides/getting-started-guide/">Node</a></li>
  </ul>
</details>
...
```sh
  cd my-folder
  git clone git@github.com:kusiLaw/-hello-react-front-end.git
```
